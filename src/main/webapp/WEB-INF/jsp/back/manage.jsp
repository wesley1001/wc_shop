...
<link href="/wc_shop/css/root.css" rel="stylesheet">
<!--
...
<!-- Start Page Loading -->
  <div class="loading"><img src="/wc_shop/img/loading.gif" alt="loading-img"></div>
  <!-- End Page Loading -->
 <!-- //////////////////////////////////////////////////////////////////////////// --> 
  <!-- START TOP -->
  <div id="top" class="clearfix">
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle hdbutton">操作 <span class="caret"></span></a>
    ...
    <li class="dropdown link">
      <a href="#" data-toggle="dropdown" class="dropdown-toggle profilebox"><img src="/wc_shop/img/star.jpg" alt="img"><b>Administrator</b><span class="caret"></span></a>
...
<ul class="sidebar-panel nav">
  <li><a ><span class="icon color5"><i class="fa fa-home"></i></span>总览</a></li>
  <li><a ><span class="icon color7"><i class="fa fa-flask"></i></span>商品操作<span class="caret"></span></a>
    <ul>
      <li><a href="">商品总览</a></li>
      <li><a href="">新增商品</a></li>
      <li><a href="">编辑商品</a></li>
  ...
  <li><a ><span class="icon color9"><i class="fa fa-th"></i></span>订单操作<span class="caret"></span></a>
    <ul>
      <li><a href="">完成订单</a></li>
      <li><a href="">修改订单</a></li>
      <li><a href="">新建订单</a></li>
...
jQuery Library
================================================ -->
<script type="text/javascript" src="/wc_shop/js/jquery.min.js"></script>
<script type="text/javascript" src="/wc_shop/js/plugins.js"></script>

<!-- ================================================
Bootstrap Core JavaScript File
================================================ -->
<script src="/wc_shop/js/bootstrap/bootstrap.min.js"></script>
<script type="text/javascript" src="/wc_shop/js/bootstrap-select/bootstrap-select.js"></script>
<script type="text/javascript" src="/wc_shop/js/bootstrap-toggle/bootstrap-toggle.min.js"></script>
<!-- ================================================
Flot Chart
================================================ -->
<!-- main file -->
<script type="text/javascript" src="/wc_shop/js/flot-chart/flot-chart.js"></script>
<!-- time.js -->
<script type="text/javascript" src="/wc_shop/js/flot-chart/flot-chart-time.js"></script>
<!-- stack.js -->
<script type="text/javascript" src="/wc_shop/js/flot-chart/flot-chart-stack.js"></script>
<!-- pie.js -->
<script type="text/javascript" src="/wc_shop/js/flot-chart/flot-chart-pie.js"></script>
<!-- demo codes -->
<script type="text/javascript" src="/wc_shop/js/flot-chart/flot-chart-plugin.js"></script>
<!-- ================================================
Easy Pie Chart
================================================ -->
<!-- main file -->
<script type="text/javascript" src="/wc_shop/js/easypiechart/easypiechart.js"></script>
<!-- demo codes -->
<script type="text/javascript" src="/wc_shop/js/easypiechart/easypiechart-plugin.js"></script>

<!-- ================================================
Sparkline
================================================ -->
<!-- main file -->
<script type="text/javascript" src="/wc_shop/js/sparkline/sparkline.js"></script>
<!-- demo codes -->
<script type="text/javascript" src="/wc_shop/js/sparkline/sparkline-plugin.js"></script>

<!-- ================================================
Rickshaw
================================================ -->
<!-- d3 -->
<script src="/wc_shop/js/rickshaw/d3.v3.js"></script>
<!-- main file -->
<script src="/wc_shop/js/rickshaw/rickshaw.js"></script>
<!-- demo codes -->
<script src="/wc_shop/js/rickshaw/rickshaw-plugin.js"></script>

<!-- ================================================
Moment.js
================================================ -->
<script type="text/javascript" src="/wc_shop/js/moment/moment.min.js"></script>
